...
今天还排查了两个实际的 MyBatis / JSON 问题：

一个是：

Integer cannot be cast to Long

已经理解了 Integer 和 Long 类型转换的问题。

另一个是：

There is no getter for property named 'likeCount'
...
从学 Spring Boot → 开始理解一个后端项目为什么这么设计。
## 12. 下一步路线图
